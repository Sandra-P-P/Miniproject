...
<body>
  <nav class="navbar navbar-expand-md sticky-top " style="background-color: rgba(0, 0, 0, 0.6);" >
        <a href="#" class="navbar-brand" style="color: white; font-weight: bold; font-size: 25px;">BeyondExams</a>
            ...
            <nav class="col-sm-3 col-md-2 menu " id="menu" style="color: white; display: block">
                ...
                <div class="left-sidebar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item menu">
                             <a style="color: white" class="nav-link <?php if (page=='addviva.php') { echo 'active';} ?>" href="viva.php"><i class="fas fa-plus-circle mr-2"></i>Add Viva</a></li>    
                        <li class="nav-item"> <li class="nav-item">
                             <a style="color: white" class="nav-link <?php if (page=='showviva.php') { echo 'active';} ?>" href="showviva.php"><i class="fas fa-store mr-2"></i>Show Viva</a></li>
                        <li class="nav-item"> <li class="nav-item">  
