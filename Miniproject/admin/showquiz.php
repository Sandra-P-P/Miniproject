...
<p class="p-2 text-white "  style="background-color: rgba(0, 0, 0, 0.6);">List of Quizes</p>';

$sql="select * from quiz where email='$email' and subject='$subject'";
...
if($result->num_rows>0)
{
    ...
    <td>'.$row["time"].' min</td>
    <td><a class="btn btn-secondary" href="quizquestion.php?q=quizquestion.php&eid='.$eid.'&total='.$total.'">Preview</a>
