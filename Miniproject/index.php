...
<head>
  ...
  <link rel="stylesheet" href="css/design1.css">
    <title>BeyondExam</title>
</head>
<body>
    <div class="bs-example">
    <nav class="navbar navbar-expand-md sticky-top" style="background-color: rgba(0, 0, 0, 0.6);" >
        <a href="#" class="navbar-brand" style="color: white; font-weight: bold; font-size: 25px;">BeyondExam</a>
    ...
    <header class="jumbotron back-image" style="background-color:#73B287">
      <div class="heading" style="padding-left: 450px; background-color:#73B287">
      <h2 class="text-light font-weight-bold text-uppercase mb-5" style="padding-top: 80px;">Welcome to<span> BeyondExam<span></h2>
        <a href="#registration" class="btn btn-light btnn" style="text-align:center">Sign Up</a>
